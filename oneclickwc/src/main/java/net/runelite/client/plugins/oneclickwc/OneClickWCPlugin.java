package net.runelite.client.plugins.oneclickwc;
...
@PluginDescriptor(
        name = "One Click WC",
        description = "Click anywhere to WC",
        tags = {"test"},
        enabledByDefault = false
)

@Slf4j
public class OneClickWCPlugin extends Plugin
{
    @Inject
    ...
    @Provides
    OneClickWCConfig provideConfig(ConfigManager configManager)
    {
        return configManager.getConfig(OneClickWCConfig.class);
    }
